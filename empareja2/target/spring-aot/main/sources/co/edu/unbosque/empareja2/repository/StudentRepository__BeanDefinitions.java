...
public class StudentRepository__BeanDefinitions {
  ...
  public static BeanDefinition getStudentRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "co.edu.unbosque.empareja2.repository.StudentRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new co.edu.unbosque.empareja2.repository.StudentRepositoryImpl__AotRepository(entityManager, context));
      }
    });
