 ...
 */
@Generated
public class Empareja2Application__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new Empareja2Application__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new Empareja2Application__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "co.edu.unbosque.empareja2.config.SecurityConfig");
