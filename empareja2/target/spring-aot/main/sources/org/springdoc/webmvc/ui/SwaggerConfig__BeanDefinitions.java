...
public class SwaggerConfig__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<SwaggerWebMvcConfigurer> getSwaggerWebMvcConfigurerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<SwaggerWebMvcConfigurer>forFactoryMethod(SwaggerConfig.class, "swaggerWebMvcConfigurer", SwaggerUiConfigProperties.class, ObjectProvider.class, ObjectProvider.class, SwaggerIndexTransformer.class, SwaggerResourceResolver.class, SwaggerWelcomeCommon.class)
