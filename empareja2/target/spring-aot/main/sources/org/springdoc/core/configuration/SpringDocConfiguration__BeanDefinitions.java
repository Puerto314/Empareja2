...
public class SpringDocConfiguration__BeanDefinitions {
  ...
  /**
   * Get the bean instance supplier for 'propertyNamingStrategyConverter'.
   */
  private static BeanInstanceSupplier<PropertyNamingStrategyConverter> getPropertyNamingStrategyConverterInstanceSupplier(
      ) {
    return BeanInstanceSupplier.<PropertyNamingStrategyConverter>forFactoryMethod(SpringDocConfiguration.class, "propertyNamingStrategyConverter", ObjectMapperProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springdoc.core.configuration.SpringDocConfiguration", SpringDocConfiguration.class).propertyNamingStrategyConverter(args.get(0)));
  }

  /**
   * Get the bean definition for 'propertyNamingStrategyConverter'.
   */
  public static BeanDefinition getPropertyNamingStrategyConverterBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(PropertyNamingStrategyConverter.class);
    beanDefinition.setLazyInit(false);
    beanDefinition.setFactoryBeanName("org.springdoc.core.configuration.SpringDocConfiguration");
    beanDefinition.setInstanceSupplier(getPropertyNamingStrategyConverterInstanceSupplier());
    return beanDefinition;
  }
