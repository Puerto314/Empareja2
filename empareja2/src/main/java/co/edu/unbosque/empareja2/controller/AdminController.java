...
/**
 * CRUD completo de usuarios (estudiantes y administradores).
 * Todos los endpoints de este controlador estan restringidos al
 * rol ADMIN en SecurityConfig ("/api/admin/**"). Un usuario normal
 * jamas puede administrar cuentas ajenas: solo la propia, a traves
 * de StudentController.
 */
@RestController
