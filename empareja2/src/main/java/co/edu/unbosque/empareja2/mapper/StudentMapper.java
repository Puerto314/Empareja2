...
/**
 * Traduce entre la entidad Student y los DTOs de entrada/salida.
 * Mantener esta logica separada evita "filtrar" campos sensibles
 * (como password) hacia las respuestas de la API.
 */
@Component
public class StudentMapper {
    ...
    /**
     * Crea una nueva entidad a partir de los datos enviados por un
     * administrador. El rol se toma del request (STUDENT o ADMIN).
     */
    ...
    /**
     * Aplica al estudiante existente los campos editables por un
     * administrador (sin tocar el password si no fue enviado; eso lo
     * decide la capa de servicio).
     */
